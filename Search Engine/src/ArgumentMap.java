...
//testing commit branch for project 3
/**
...
public class ArgumentMap {
	...
	public static boolean isValue(String arg) {
		...
		return (!arg.strip().isEmpty() && !arg.startsWith("-"));
	}

	/**
	 * Returns the number of unique flags. Because there is no duplicates in map
	 * key, so just return the map size
	 *
